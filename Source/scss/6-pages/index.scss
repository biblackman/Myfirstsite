...
<!-- replace name-->
								Hoodie stumptown kitsch <span class="item__date">05/05/2015</span></h3>
							<div class="item__details">
								<ul>
									<li><i class="icon icon-camera"></i><span> Nikon D750 </span></li>
...
<!--Events-->
				<div class="stack">
					...
					<div class="item">
						<div class="item__content">
							<img src="img/type2/20180401Awards_69.JPG" alt="img01" />
							<h3 class="item__title">Awards <span class="item__date">03/23/2018</span></h3>
							<div class="item__details">
								<ul>
									<li><i class="icon icon-camera"></i><span>Nikon D750</span></li>
									<li><i class="icon icon-focal_length"></i><span>22.5 mm</span></li>
					...
					<div class="item">
						<div class="item__content">
							<img src="img/type2/20180401Awards_32.JPG" alt="img02" />
							<h3 class="item__title">Awards <span class="item__date">03/23/2018</span></h3>
							<div class="item__details">
								<ul>
									<li><i class="icon icon-camera"></i><span>Nikon D750</span></li>
					...
					<div class="item">
						<div class="item__content">
							<img src="img/type2/20180401Awards_87.JPG" alt="img03" />
							<h3 class="item__title">Awards<span class="item__date">03/23/2018</span></h3>
							<div class="item__details">
								<ul>
									<li><i class="icon icon-camera"></i><span>Nikon D750</span></li>
					...
					<div class="item">
						<div class="item__content">
							<img src="img/type2/20180401Awards_41.JPG" alt="img04" />
							<h3 class="item__title">Awards<span class="item__date">03/23/2018</span></h3>
							<div class="item__details">
								<ul>
									<li><i class="icon icon-camera"></i><span>Nikon D750</span></li>
					...
					<div class="item">
						<div class="item__content">
							<img src="img/type2/20180401Awards_46.JPG" alt="img05" />
							<h3 class="item__title">Awards <span class="item__date">03/23/2018</span></h3>
							<div class="item__details">
								<ul>
									<li><i class="icon icon-camera"></i><span>Nikon D750</span></li>
...
<!-- Travel-->					
					<h2 class="stack-title"><a href="#" data-text="Wildlife"><span>Travel</span></a></h2>
					<div class="item">
						<div class="item__content">
